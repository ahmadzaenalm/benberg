...
if( ! class_exists( 'Custom_Post_Type' ) ) {
	...
	class Custom_Post_Type {
		...
		public function __construct() {
			add_action('init', array($this, 'corpboot_register_portfolio'), 0);
			add_action('init', array($this, 'corpboot_register_team'), 0);
		}

		public function corpboot_register_portfolio() {
        ...
        public function corpboot_register_team() {
			$post_type_labels       = array(
				'name'                => 'Teams',
				'singular_name'       => 'Team',
				'menu_name'           => 'Team',
			...
			register_taxonomy( 'team-tag', array('team'), $taxonomy_tags_args );
