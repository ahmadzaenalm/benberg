...
//===========================================================================================
    $window.on('load', function() {
        ...
        $(".content-ready .container-fluid .row .col-md-12").append(
            "<p class='title-ready'>BénBérg Arôme</p><br><h1>ARE YOU READY TO BE<br>SUCCESS WITH US?</h1><br><button class='btn-lg btn-ready btn-transparent'>See More <span><li class='fa fa-chevron-right'></li></span></button>"
    ...
    $document.on('ready', function() {
        ...
        $window.on('scroll', function() {
            if ($document.scrollTop() < 120) {
                ...
                $('.navbar-fixed-top').css('top','3.1em');
